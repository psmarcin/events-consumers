...
func Get(ctx context.Context, m PubSubMessage) error {
	...
	// publish event
	err = publish(pubsubClient, ctx, processContentTopicID, serialized)
	if err != nil {
...
func publish(client *pubsub.Client, ctx context.Context, topicID string, message string) error {
